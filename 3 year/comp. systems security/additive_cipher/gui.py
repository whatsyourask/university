...
class GraphicUI:
    ...
    def __init__(self) -> None:
        ...
        # Создать фрейм,q на котором будут располагаться элементы
    ...
    def radiobutton(self, column, row, sticky, text, variable, value, command):
        radio = Radiobutton(self.__mainframe, text=text, variable=variable,
